...
public:
    ...
    {
        draw_text(50, 50, "This point-cloud is generated Se ha modificado para usos de desarroyo:");
...
{
    window app(1280, 1500, "R3Dsystem");
 ...
 // Ajusta las posiciones para organizar los elementos en una columna
    ...
    ///En esta seccion se van a mandar a llamar las variables que se ocupan para el funcionamiento del envio de datos 
    int GAltitude,GAsimut,GRoll;/// Son los datos que regresa la funcion calcularGrados
    int radioEsfera=299;////Esta datos sera ingresado desde la interface de ususario 
